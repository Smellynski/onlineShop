 ...
 */
final class Version20230616143735 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD shopping_cart LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', DROP shopping_cart_id');
    }
}
